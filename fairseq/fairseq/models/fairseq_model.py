...
class FairseqDetModel(BaseFairseqModel):
    """Base class for encoder-decoder models.
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens):
        ...
        """
        encoder_out = self.encoder(src_tokens, src_lengths)
        decoder_out, avg_attn_scores, det_loss = self.decoder(prev_output_tokens, encoder_out)
...
class FairseqKLModel(BaseFairseqModel):
    """Base class for encoder-decoder models.
    ...
    def forward(self, src_tokens, src_lengths, prev_output_tokens):
        ...
        """
        encoder_out = self.encoder(src_tokens, src_lengths)
        decoder_out, avg_attn_scores, kl_loss = self.decoder(prev_output_tokens, encoder_out)
