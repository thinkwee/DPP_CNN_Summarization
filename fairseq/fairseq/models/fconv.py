...
@register_model_architecture('fconv', 'summ_vanilla')
def summarization_architecture(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', "./data_bin/cnndm/model_cnndm_256.vec")
    args.encoder_layers = getattr(args, 'encoder_layers', '[(256, 5)] * 20')
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 256)
    args.decoder_embed_path = getattr(args, 'decoder_embed_path', "./data_bin/cnndm/model_cnndm_256.vec")
...
@register_model_architecture('fconv', 'summ_vanilla_small')
def summarization_architecture_small(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', "./data_bin/cnndm/model_cnndm_256.vec")
    args.encoder_layers = getattr(args, 'encoder_layers', '[(256, 5)] * 20')
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 256)
    args.decoder_embed_path = getattr(args, 'decoder_embed_path', "./data_bin/cnndm/model_cnndm_256.vec")
    args.decoder_layers = getattr(args, 'decoder_layers', '[(256, 3)] * 2')
    args.decoder_out_embed_dim = getattr(args, 'decoder_out_embed_dim', 256)
    args.decoder_attention = getattr(args, 'decoder_attention', 'True')
    args.share_input_output_embed = getattr(args, 'share_input_output_embed', False)
    args.adaptive_softmax_cutoff = getattr(args, 'adaptive_softmax_cutoff', [5000,10000,20000])

@register_model_architecture('fconv', 'summ_vanilla_large')
def summarization_architecture_large(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 256)
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', "./data_bin/cnndm/model_cnndm_256.vec")
    args.encoder_layers = getattr(args, 'encoder_layers', '[(256, 5)] * 20')
...
@register_model_architecture('fconv', 'summ_vanilla_huge')
def summarization_architecture_huge(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_embed_path = getattr(args, 'encoder_embed_path', "./data_bin/cnndm/model_cnndm_512.vec")
    args.encoder_layers = getattr(args, 'encoder_layers', '[(512, 5)] * 20')
    args.decoder_embed_dim = getattr(args, 'decoder_embed_dim', 512)
    args.decoder_embed_path = getattr(args, 'decoder_embed_path', "./data_bin/cnndm/model_cnndm_512.vec")
