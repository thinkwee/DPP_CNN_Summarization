...
@register_task('summ_tldr')
class SummarizationTLDRTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--max-source-positions', default=400, type=int, metavar='N',
                            help='max number of tokens in the source sequence')
        parser.add_argument('--max-target-positions', default=40, type=int, metavar='N',
    ...
    def load_pretrained_model(path, src_dict_path, tgt_dict_path, arg_overrides=None):
        ...
        task = SummarizationTLDRTask(args, src_dict, tgt_dict)
