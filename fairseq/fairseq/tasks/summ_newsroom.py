...
@register_task('summ_newsroom')
class SummarizationNEWSROOMTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--max-source-positions', default=420, type=int, metavar='N',
    ...
    def load_pretrained_model(path, src_dict_path, tgt_dict_path, arg_overrides=None):
        ...
        task = SummarizationNEWSROOMTask(args, src_dict, tgt_dict)
