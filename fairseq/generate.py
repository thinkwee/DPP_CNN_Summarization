...
def main(args):
    ...
    result_output_list = ["/systems/", "/models/", "/alignments/", "-nounk/systems/", "-nounk/models/", "/attention/"]
    ...
    with progress_bar.build_progress_bar(args, itr) as t:
        ...
        for sample in t:
            ...
            for i, sample_id in enumerate(sample['id'].tolist()):
                ...
                for idx, hypo in enumerate(hypos[i][:min(len(hypos), args.nbest)]):
                    ...
                    # generate results
                    with open(file_head + "/systems/system." + str(sample_id) + ".txt", "w") as f:
                        f.writelines(target_str)
                    with open(file_head + "/models/model." + str(sample_id) + ".txt", "w") as f:
                    ...
                    with open(file_head + "-nounk/systems/system." + str(sample_id) + ".txt", "w") as f:
                        f.writelines(target_str)
                    with open(file_head + "-nounk/models/model." + str(sample_id) + ".txt", "w") as f:
                        f.writelines(hypo_str)
    ...
    print('| Summarized {} articles ({} tokens) in {:.1f}s ({:.2f} articles/s, {:.2f} tokens/s)'.format(
